        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem className="flex w-full flex-col gap-3">
              ...
              <FormDescription className="body-regular mt-2.5 text-light-500">
                Introduce your problem and explain what you put in title.
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem className="flex w-full flex-col">
                  ...
                  {field.value.length > 0 && (
                    <div className="flex-start mt-2.5 gap-2.5">
                      {field.value.map((tag: any) => (
                        <Badge
                          key={tag}
                          className="body-medium background-light800_dark300 text-dark400_light500 flex-center cursor-pointer gap-2 rounded-md border-none px-4 py-2 capitalize"
              ...
              <FormDescription className="body-regular mt-2.5 text-light-500">
                Add upto 3 tags describing your question.
              </FormDescription>
              <FormMessage className="text-red-500" />
            </FormItem>
          )}
